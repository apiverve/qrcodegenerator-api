...
namespace APIVerve.API.QRCodeGenerator
{
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "size", new ValidationRule { Type = "number", Required = false } },
            { "margin", new ValidationRule { Type = "number", Required = false } },
            { "color", new ValidationRule { Type = "string", Required = false } },
            { "backgroundColor", new ValidationRule { Type = "string", Required = false } },
            { "dotStyle", new ValidationRule { Type = "string", Required = false } },
            { "cornerSquareStyle", new ValidationRule { Type = "string", Required = false } },
            { "cornerDotStyle", new ValidationRule { Type = "string", Required = false } },
            { "gradient", new ValidationRule { Type = "object", Required = false } },
            { "logo", new ValidationRule { Type = "string", Required = false, Format = "url" } },
            { "logoSize", new ValidationRule { Type = "number", Required = false } },
            { "logoMargin", new ValidationRule { Type = "number", Required = false } }
        };
        ...
        private void ValidateParams(QRCodeGeneratorQueryOptions options)
        {
