...
{
    class QRCodeGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/qrcodegenerator";

        /// <summary>
        /// Make a POST request to the QR Code Generator API
        /// </summary>
        static async Task<JsonDocument> CallQRCodeGeneratorAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { value &#x3D; &quot;https://apiverve.com&quot;, type &#x3D; &quot;url&quot;, format &#x3D; &quot;png&quot;, margin &#x3D; &quot;0&quot; };
        ...
        {
            Console.WriteLine("📤 Calling QR Code Generator API...\n");

            var result = await CallQRCodeGeneratorAPI();
